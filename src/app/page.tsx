...
export default function Home() {
  return <><SiteHeader /><main>
    ...
    <section className="mx-auto max-w-7xl px-5 pt-20 md:pt-28"><div className="flex items-end justify-between"><div><p className="eyebrow">Combos con mejor precio</p><h2 className="mt-3 font-display text-4xl md:text-5xl">Encontrá el kit ideal.</h2></div><Link href="/kits" className="hidden items-center gap-1 text-sm text-gold md:flex">Ver todos <ArrowUpRight size={16} /></Link></div><KitsSection /></section>
