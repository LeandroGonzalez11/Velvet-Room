...
export function whatsappUrl(product?: Product) {
  ...
  const text = product ? `Hola, me interesa este producto:%0A%0ANombre: ${product.name}%0APrecio: ${price}%0A%0A¿Está disponible?` : "Hola, quisiera hacer una consulta sobre Velvet Room.";
